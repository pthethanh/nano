...
func Error(code Code, format string, args ...interface{}) error {
	...
	if len(args) == 0 {
		return status.Error(code, format)
	}
...
func OK(format string, args ...interface{}) *Status {
	return New(codes.OK, format, args...)
}
...
func Canceled(format string, args ...interface{}) error {
	return Error(codes.Canceled, format, args...)
}
...
func Unknown(format string, args ...interface{}) error {
	return Error(codes.Unknown, format, args...)
}
...
func InvalidArgument(format string, args ...interface{}) error {
	return Error(codes.InvalidArgument, format, args...)
}
...
func DeadlineExceeded(format string, args ...interface{}) error {
	return Error(codes.DeadlineExceeded, format, args...)
}
...
func NotFound(format string, args ...interface{}) error {
	return Error(codes.NotFound, format, args...)
}
...
func AlreadyExists(format string, args ...interface{}) error {
	return Error(codes.AlreadyExists, format, args...)
}
...
func PermissionDenied(format string, args ...interface{}) error {
	return Error(codes.PermissionDenied, format, args...)
}
...
func ResourceExhausted(format string, args ...interface{}) error {
	return Error(codes.ResourceExhausted, format, args...)
}
...
func FailedPrecondition(format string, args ...interface{}) error {
	return Error(codes.FailedPrecondition, format, args...)
}
...
func Aborted(format string, args ...interface{}) error {
	return Error(codes.Aborted, format, args...)
}
...
func OutOfRange(format string, args ...interface{}) error {
	return Error(codes.OutOfRange, format, args...)
}
...
func Unimplemented(format string, args ...interface{}) error {
	return Error(codes.Unimplemented, format, args...)
}
...
func Internal(format string, args ...interface{}) error {
	return Error(codes.Internal, format, args...)
}
...
func Unavailable(format string, args ...interface{}) error {
	return Error(codes.Unavailable, format, args...)
}
...
func DataLoss(format string, args ...interface{}) error {
	return Error(codes.DataLoss, format, args...)
}
...
func Unauthenticated(format string, args ...interface{}) error {
	return Error(codes.Unauthenticated, format, args...)
}
