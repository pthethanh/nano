...
const file_broker_proto_rawDesc = "" +
	"\n" +
	"\fbroker.proto\x12\x06broker\"\x8d\x01\n" +
	"\aMessage\x123\n" +
	"\x06header\x18\x01 \x03(\v2\x1b.broker.Message.HeaderEntryR\x06header\x12\x12\n" +
	"\x04body\x18\x02 \x01(\fR\x04body\x1a9\n" +
	"\vHeaderEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B)Z'github.com/pthethanh/nano/broker;brokerb\x06proto3"
